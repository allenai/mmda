...
from mmda.utils.tools import MergeSpans, box_groups_to_span_groups
...
class TestMergeNeighborSpans(unittest.TestCase):
    ...
    def test_handling_of_boxes(self):
        ...
        assert out[0].box.coordinates == Box(l=0, t=0, w=3, h=3, page=0).coordinates
        # unmerged spans from separate pages keep their original box
        assert out[1].box.coordinates == spans[-1].box.coordinates
        ...
        assert out[1].end == 150
        assert out[0].box.coordinates == Box(l=0, t=0, w=3, h=3, page=1).coordinates
...
list_of_spans_to_merge = [
    Span(
        ...
        box=Box(
            l=0.19238134915568578,
            t=0.22752901673615306,
            w=0.06941334053447479,
            h=0.029442207414270286,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.27220460878651254,
            t=0.22752901673615306,
            w=0.03468585042904468,
            h=0.029442207414270286,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.4204075769894973,
            t=0.34144142726484455,
            w=0.023417310961637895,
    ...
    Span(
        ...
        box=Box(
            l=0.5182742633669088,
            t=0.34144142726484455,
            w=0.029000512031393755,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    ...
    Span(
        ...
        box=Box(
            l=0.2686971421659869,
            t=0.36273518298114954,
            w=0.08479235581478171,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.40387889180816966,
            t=0.36273518298114954,
            w=0.08368776567508182,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.4943548659781345,
            t=0.36273518298114954,
            w=0.042396177907390975,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.5435392523804085,
            t=0.36273518298114954,
            w=0.11491754144296094,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.6876581404256177,
            t=0.36273518298114954,
            w=0.09146006356715199,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.2686971421659869,
            t=0.4479113936500019,
            w=0.06846450520430858,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    ...
    Span(
        ...
        box=Box(
            l=0.2686971421659869,
            t=0.49049890508261185,
            w=0.07810456460532592,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.35061756361754887,
            t=0.49049890508261185,
            w=0.03904224057412029,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.39347566103790516,
            t=0.49049890508261185,
            w=0.023417310961637943,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.4207088288457791,
            t=0.49049890508261185,
            w=0.08254300862121101,
            h=0.014200429984914883,
            page=4,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.5070676943132262,
            t=0.49049890508261185,
            w=0.09481400090042272,
            h=0.014200429984914883,
            page=4,
        ),
    ),
...
list_of_spans_to_merge_2 = [
    ...
    Span(
        ...
        box=Box(
            l=0.17929474059091924,
            t=0.3578497466414853,
            w=0.030687522426571887,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    ...
    Span(
        ...
        box=Box(
            l=0.26740086682480063,
            t=0.3578497466414853,
            w=0.050208642713631964,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    ...
    Span(
        ...
        box=Box(
            l=0.37404402394855496,
            t=0.3578497466414853,
            w=0.0769598075514552,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.4569284513402187,
            t=0.3578497466414853,
            w=0.029000512031393852,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.4918334997547357,
            t=0.3578497466414853,
            w=0.0792091547450259,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.5769471908828846,
            t=0.3578497466414853,
            w=0.07175819216632291,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    ...
    Span(
        ...
        box=Box(
            l=0.6947366666890655,
            t=0.3578497466414853,
            w=0.03904224057412024,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.7396834436463088,
            t=0.3578497466414853,
            w=0.05020864271363187,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.7957966227430638,
            t=0.3578497466414853,
            w=0.015624929612482252,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.12095229775767885,
            t=0.37500875791374183,
            w=0.024541984558423317,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.1518205712980198,
            t=0.37500875791374183,
            w=0.07695980755145514,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.2351066678313926,
            t=0.37500875791374183,
            w=0.013395665875996984,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.2548286226893072,
            t=0.37500875791374183,
            w=0.02231272082193805,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    ...
    Span(
        ...
        box=Box(
            l=0.33628712462790383,
            t=0.37500875791374183,
            w=0.055570925755447906,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.3981843393652693,
            t=0.37500875791374183,
            w=0.04183384110899822,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.44668588822663785,
            t=0.37500875791374183,
            w=0.03570838669793504,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.4887205639064905,
            t=0.37500875791374183,
            w=0.020083457085452783,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.5151303099738609,
            t=0.37500875791374183,
            w=0.08810612623388145,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    ...
    Span(
        ...
        box=Box(
            l=0.6601529535879158,
            t=0.37500875791374183,
            w=0.03958449391542752,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.7098795933314969,
            t=0.37500875791374183,
            w=0.035708386697935225,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.7519142690113497,
            t=0.37500875791374183,
            w=0.013395665875997033,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.7716362238692644,
            t=0.37500875791374183,
            w=0.008917054945941066,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.7868795677971232,
            t=0.37500875791374183,
            w=0.02454198455842322,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.12095229775767885,
            t=0.3921677691859983,
            w=0.08031374488472577,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    ...
    Span(
        ...
        box=Box(
            l=0.30557951874424644,
            t=0.3921677691859983,
            w=0.08143841848151108,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.3920388014971207,
            t=0.3921677691859983,
            w=0.016729519752182193,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.4137891855206661,
            t=0.3921677691859983,
            w=0.0535625800469026,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.47237262983893197,
            t=0.3921677691859983,
            w=0.05354249658981717,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.5309359907001122,
            t=0.3921677691859983,
            w=0.03681297683763493,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.5727698318091105,
            t=0.3921677691859983,
            w=0.01672951975218224,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.5945202158326559,
            t=0.3921677691859983,
            w=0.060230287799273016,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.6597713679032922,
            t=0.3921677691859983,
            w=0.029000512031393946,
            h=0.014200429984914883,
            page=19,
        ),
    ),
    Span(
        ...
        box=Box(
            l=0.6937927442060494,
            t=0.3921677691859983,
            w=0.07834556609035141,
            h=0.014200429984914883,
            page=19,
        ),
    ),
...
def test_merge_spans():
    assert len(list_of_spans_to_merge) == (
        len(
            MergeSpans(
                list_of_spans_to_merge, 0, 0
    ...
    assert 4 == len(
        MergeSpans(
            list_of_spans_to_merge, 0.04387334, 0.01421097
        ).merge_neighbor_spans_by_box_coordinate()
    )
    ...
    assert [30113, 30359] == [
        merge_spans.merge_neighbor_spans_by_box_coordinate()[0].start,
        merge_spans.merge_neighbor_spans_by_box_coordinate()[0].end,
    ]
...
def test_merge_neighbor_spans_by_symbol_distance():
    assert 7 == (
        len(
            MergeSpans(
                list_of_spans_to_merge, index_distance=10
            ).merge_neighbor_spans_by_symbol_distance()
        )
    )
    ...
    assert 10 == len(
        MergeSpans(
            list_of_spans_to_merge, index_distance=1
        ).merge_neighbor_spans_by_symbol_distance()
    )
    ...
    assert [Box(l=0.1, t=0.2, w=0.4, h=0.2, page=11).coordinates] == [
        entry.box.coordinates for entry in result
    ]
...
def test_from_span_groups_with_box_groups():
    ...
    assert 7 == (
        len(
            MergeSpans.from_span_groups_with_box_groups(
                list_of_spans_to_merge_in_span_group_format, index_distance=10
            ).merge_neighbor_spans_by_symbol_distance()
        )
    )
    ...
    assert len(list_of_spans_to_merge) == (
        len(
            MergeSpans.from_span_groups_with_box_groups(
                list_of_spans_to_merge_in_span_group_format, 0, 0
            ).merge_neighbor_spans_by_box_coordinate()
        )
    )
...
def test_box_groups_to_span_groups():
    ...
    with open(
        fixture_path / "20fdafb68d0e69d193527a9a1cbe64e7e69a3798__pdfplumber_doc.json",
        "r",
    ) as f:
        raw_json = f.read()
    ...
    with open(
        fixture_path / "20fdafb68d0e69d193527a9a1cbe64e7e69a3798__bib_entries.json", "r"
    ) as f:
        raw_json = f.read()
    ...
    overlap_at_token_center_span_groups = box_groups_to_span_groups(
        box_groups, doc, center=True
    )
    overlap_at_token_center_span_groups_x_padded = box_groups_to_span_groups(
        box_groups, doc, center=True, pad_x=True
    )

    assert (
        len(box_groups)
        == len(overlap_span_groups)
        == len(overlap_at_token_center_span_groups)
        == len(overlap_at_token_center_span_groups_x_padded)
    )

    # annotate all onto doc to extract texts:
    doc.annotate(overlap_span_groups=overlap_span_groups)
    doc.annotate(
        overlap_at_token_center_span_groups=overlap_at_token_center_span_groups
    )
    doc.annotate(
        overlap_at_token_center_span_groups_x_padded=overlap_at_token_center_span_groups_x_padded
    )
    ...
    assert all(
        [sg.box_group is not None for sg in doc.overlap_at_token_center_span_groups]
    )

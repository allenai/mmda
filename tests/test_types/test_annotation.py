...
class TestBoxGroup(unittest.TestCase):
    def setUp(cls) -> None:
        cls.box_group_json = {
            "boxes": [
                {"left": 0.1, "top": 0.6, "width": 0.36, "height": 0.221, "page": 0}
            ],
            "id": None,
            "type": "Text",
        }
    ...
    def test_from_json(self):
        ...
        self.assertEqual(
            BoxGroup.from_json(self.box_group_json).boxes[0].to_json(),
            Box(l=0.1, t=0.6, w=0.36, h=0.221, page=0).to_json(),
        )

...
import pytest
from mmda.parsers.grobid_full_text_parser import GrobidFullTextParser
from mmda.parsers.pdfplumber_parser import PDFPlumberParser

os.chdir(pathlib.Path(__file__).parent)

PDF_PATH = "../fixtures/grobid_full_text_parser/0c027af0ee9c1901c57f6579d903aedee7f4.pdf"
